...
public class _04_Add_Product_To_Cart_Checkout_And_Verify_Cancel_Button_Functionality extends BaseTest {
	...
	public void Verify_Cancel_Button_Functionality_On_Checkout_Page() {
		...
		CheckoutOverviewPage checkoutOverviewPage = checkoutYourInformationPage.fillCheckoutInfo("Albus", "Severus",
				"9-3/4");
	...
	// Intentionally failed and skipped the below test cases to see everything
	// getting captured in the extent report properly or not
	...
	@Test(enabled = false, dependsOnMethods = { "Verify_Cancel_Button_Functionality_On_Checkout_Page",
			"Verify_Wrong_Functionality_On_Checkout_Page" })
